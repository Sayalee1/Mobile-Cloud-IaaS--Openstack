...
import emulator.androidvm.androidvm;
 ...
 */
public class CreateInstance extends HttpServlet implements Closeable
{
	/**
	 * 
	 */
	...
	public static String provider_281 = "openstack-nova";
	public static String identity_281 = "admin:admin"; // tenantName:userName
	public static String credential_281 = "Passw0rd";
	public static String url_281 = "http://192.168.47.141";
	public static String JDBC_Driver = "com.mysql.jdbc.Driver";
	public static String DB_URl = "jdbc:mysql://us-cdbr-iron-east-02.cleardb.net/ad_dd04da4b2fa8fee";
	public static String user = "b1a0963e48fe10";
	public static String password = "3bb69fb409842cf";
	...
	//public DateTimeAtCreation m_creationTime = new DateTimeAtCreation(null);
			...
			HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if (request.getParameter("CreateInstance") != null)
		{
			System.out.print("Working");
			//System.out.println("hi this is create instacne script before call");
			//CreateInstance createInst_281 = new CreateInstance( "",  "");
			...
			try
			{
				...
				System.out.print("Connection log"+conn);
