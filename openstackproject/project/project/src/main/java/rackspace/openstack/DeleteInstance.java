...
public class DeleteInstance extends HttpServlet
{
	...
	public long m_deletiondateTime;
	...
	protected void doPost(HttpServletRequest request,
		...
		if (request.getParameter("DeleteInstance") !=null)
		{
			...
			System.out.println("Successsfuly Deleting instance number --- " + servers.get(2).getId().toString());
			m_deletiondateTime = System.currentTimeMillis();
